    ...
    <div className='App'>
      <div className='home'>
        <div className='sidebar'>
          <div className='logo-div'><img className='logo-img' src='https://i.imgur.com/GzJv4mS.png' alt='Make You Scream Logo' title='Make You Scream Logo' /></div>
          <AboutMovie
            movie={movie}
          ...
          <button className='generate-btn' onClick={fetchRandomHorrorMovie}>Click Me</button>
        </div>
        <div className='main'>
